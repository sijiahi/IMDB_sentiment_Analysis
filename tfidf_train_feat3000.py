...
X_train, train_labels = tfidf.tf_idf_2doc(train_data, train_labels, feat=3000)
print('\nVectoring test data')
X_test, test_labels = tfidf.tf_idf_2doc(test_data, test_labels, feat=3000)
...
print('\nInitializing model')
model = im.default_modelConf(size=3000)
print('\nTraining model')
...
plt.grid()
plt.show()
model.save('models/tfidf_default_40000_feat3000.h5')
plt.savefig('report/tfidf_default_40000_feat3000.png')
with open('report/tfidf_default_40000_feat3000.txt', 'wb') as fhis:
