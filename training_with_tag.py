...
print('filtering vocabulary list')
...
(train_data, train_labels), (test_data, test_labels) = imdb.load_data(word_index, num_words=10000)
...
plt.show()
model.save('models/filtered_model.h5')
